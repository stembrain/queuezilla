...
class OAuth_Consumer { 
	...
	private $consumerName = null;
	
	public function __construct($consumerKey, $consumerSecret = '', $consumerName) {
	...
	public function delete($accessTokenKey, $accessTokenSecret, $url) {
		$accessToken = new OAuthToken($accessTokenKey, $accessTokenSecret);
		$request = $this->createRequest('DELETE', $url, $accessToken, array());
		
		return $this->doDelete($request->to_url());
	}
	...
	public function getFullResponseXML(){
		return htmlentities($this->fullResponse);
	}
