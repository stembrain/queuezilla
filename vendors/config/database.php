...
class DATABASE_CONFIG {
	...
	// taken from http://edwardawebb.com/web-development/cakephp/automatically-choose-database-connections-cakephp
	function __construct (){
		if(isset($_SERVER['SERVER_NAME'])){
			switch($_SERVER['SERVER_NAME']){
				case 'stembrain.local':
					$this->default = $this->development;
					break;
				case 'stembrain.com':
				case 'www.stembrain.com':
